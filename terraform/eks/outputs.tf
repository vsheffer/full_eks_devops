...
output "bootstrap_node_group_role_arn" {
  description = "ARN of the worker nodes IAM role"
  value       = module.bootstrap_node_group.eks_node_group_role_arn
}

output "bootstrap_node_group_role_name" {
  description = "Name of the worker nodes IAM role"
  value       = module.bootstrap_node_group.eks_node_group_role_name
}

output "bootstrap_node_group_id" {
  description = "EKS Cluster name and EKS Node Group name separated by a colon"
  value       = module.bootstrap_node_group.eks_node_group_id
}

output "bootstrap_node_group_arn" {
  description = "Amazon Resource Name (ARN) of the EKS Node Group"
  value       = module.bootstrap_node_group.eks_node_group_arn
}

output "bootstrap_node_group_resources" {
  description = "List of objects containing information about underlying resources of the EKS Node Group"
  value       = module.bootstrap_node_group.eks_node_group_resources
}

output "bootstrap_node_group_status" {
  description = "Status of the EKS Node Group"
  value       = module.bootstrap_node_group.eks_node_group_status
}
